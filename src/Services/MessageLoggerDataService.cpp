...
MessageLoggerDataService::MessageLoggerDataService(std::shared_ptr<uxas::communications::LmcpObjectNetworkClient> pLmcpObjectNetworkClient)
: ServiceBase(MessageLoggerDataService::s_typeName(), MessageLoggerDataService::s_directoryName(), pLmcpObjectNetworkClient)
{
};
