...
SerialAutomationRequestTestService::SerialAutomationRequestTestService(std::shared_ptr<uxas::communications::LmcpObjectNetworkClient> pLmcpObjectNetworkClient)
: ServiceBase(SerialAutomationRequestTestService::s_typeName(), SerialAutomationRequestTestService::s_directoryName(), pLmcpObjectNetworkClient)
{
};
