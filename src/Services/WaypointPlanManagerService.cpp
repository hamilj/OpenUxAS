...
WaypointPlanManagerService::WaypointPlanManagerService(std::shared_ptr<uxas::communications::LmcpObjectNetworkClient> pLmcpObjectNetworkClient)
: ServiceBase(WaypointPlanManagerService::s_typeName(), WaypointPlanManagerService::s_directoryName(), pLmcpObjectNetworkClient) { };
