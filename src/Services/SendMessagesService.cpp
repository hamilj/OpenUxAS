...
SendMessagesService::SendMessagesService(std::shared_ptr<uxas::communications::LmcpObjectNetworkClient> pLmcpObjectNetworkClient)
:ServiceBase(SendMessagesService::s_typeName(), "", pLmcpObjectNetworkClient),
