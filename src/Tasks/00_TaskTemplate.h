...
public:
    ...
    {
        return uxas::stduxas::make_unique<TaskTemplate>(pLmcpObjectNetworkClient);
    };

    explicit TaskTemplate(std::shared_ptr<uxas::communications::LmcpObjectNetworkClient> pLmcpObjectNetworkClient);
