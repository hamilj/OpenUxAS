...
public:
    ...
    {
        return new CmasiLineSearchTaskService(std::move(pLmcpObjectNetworkClient));
    };

    explicit CmasiLineSearchTaskService(std::unique_ptr<uxas::communications::LmcpObjectNetworkClient> pLmcpObjectNetworkClient);
