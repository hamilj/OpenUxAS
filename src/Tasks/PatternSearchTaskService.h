...
public:
    ...
    {
       return uxas::stduxas::make_unique<PatternSearchTaskService>(pLmcpObjectNetworkClient);
    };

    explicit PatternSearchTaskService(std::shared_ptr<uxas::communications::LmcpObjectNetworkClient> pLmcpObjectNetworkClient);
