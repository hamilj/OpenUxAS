...
/* 
 * File:   Task_MultiVehicleWatchTask.h
 * Author: Derek & steve
 *
 * Created on March 7, 2016, 6:17 PM
 */

#ifndef UXAS_SERVICE_TASK_MULTI_VEHICLE_WATCH_TASK_SERVICE_H
#define UXAS_SERVICE_TASK_MULTI_VEHICLE_WATCH_TASK_SERVICE_H
...
/*! \class MultiVehicleWatchTaskService
...
class MultiVehicleWatchTaskService : public TaskServiceBase
{
public:

    static const std::string&
    s_typeName() {
        static std::string s_string("MultiVehicleWatchTaskService");
        return (s_string);
    };
    ...
    {
        std::vector<std::string> registryServiceTypeNames = {s_typeName(), "afrl.impact.MultiVehicleWatchTask"};
...
private:
    ...
    static
    ServiceBase::CreationRegistrar<MultiVehicleWatchTaskService> s_registrar;

    /** brief Copy construction not permitted */
    MultiVehicleWatchTaskService(MultiVehicleWatchTaskService const&) = delete;

    /** brief Copy assignment operation not permitted */
    void operator=(MultiVehicleWatchTaskService const&) = delete;
...
#endif /* UXAS_SERVICE_TASK_MULTI_VEHICLE_WATCH_TASK_SERVICE_H */
