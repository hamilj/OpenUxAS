...
MustFlyTaskService::MustFlyTaskService(std::shared_ptr<uxas::communications::LmcpObjectNetworkClient> pLmcpObjectNetworkClient)
    : TaskServiceBase(MustFlyTaskService::s_typeName(), MustFlyTaskService::s_directoryName(), pLmcpObjectNetworkClient)
{
};
